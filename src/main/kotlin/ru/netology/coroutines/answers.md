...
Блок try{}catch не сработает, т.к. supervisorScope успешно запустит оба процесса асинхронно. Затем они успешно выбросят исключения уже после завершения блока try{}catch
