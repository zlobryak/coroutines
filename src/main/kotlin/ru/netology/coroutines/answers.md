...
Блок try{}catch не сработает, т.к. supervisorScope успешно запустит оба процесса ассинхронно. Затем они успешно выбросят исключения уже после завершения блока try{}catch
